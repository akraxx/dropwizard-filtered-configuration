...
/**
 * A {@link io.dropwizard.configuration.ConfigurationException} for errors parsing a configuration file.
 */
public class ConfigurationParsingException extends ConfigurationException {
    ...
    static class Builder {
         ...
         *
         * @return a {@link java.util.List} with each element in the path in order, beginning at the root; or
    ...
    /**
     * Create a mutable {@link Builder} to incrementally build a {@link io.dropwizard.configuration.ConfigurationParsingException}.
     *
     * @param brief the brief summary of the error.
     *
     * @return a mutable builder to incrementally build a {@link io.dropwizard.configuration.ConfigurationParsingException}.
     */
